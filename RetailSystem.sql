...
-- select name as Client_name from Customers;
-- select name , price as Cost from Products;
-- select * from Orders;
-- select distinct city from Customers;
-- select name as Name ,city as Location from Customers;
-- select name from Products where Products.category = "Electronics";

-- select * from Products where price>10000;

-- select name from Customers where city="Hyderabad";
-- select name from Products where category = "Electronics" and price>20000;
-- select * from Products where category = "Electronics" or price<5000;
-- select * from Products where price  BETWEEN 10000 and 30000;
-- select name from Customers where city in ('Hyderabad','Delhi');
-- select name from Customers where name like "A%";
-- select name from Products where name like "%oo%";
-- select name from Products where category!="Electronics";
-- select name from Products where price > 10000 and price< 50000 and category='Electronics';
...
-- select Orders.order_id,Customers.name from Customers
-- Right Join Orders
-- on Customers.customer_id=Orders.customer_id;
...
-- select Customers.name ,COUNT(Orders.order_id) From Customers
-- LEFT JOIN Orders
-- ON Customers.customer_id= Orders.customer_id
-- Group by Orders.customer_id, Customers.name
-- Having count(Orders.order_id)>1;

-- select Customers.name,SUM(Products.price*Order_items.quantity),Count(Distinct Orders.order_id) 
-- from Customers
-- left join Orders
...
-- Having sum(Products.price*Order_items.quantity)>50000
